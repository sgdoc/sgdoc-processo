...
function ImageFlow ()
{
	...
	this.init = function (options)
	{
		...
		if(ImageFlowDiv)
		{
			...
			if(this.createStructure())
			{
				...
				this.descDiv = document.getElementById(thisObject.ImageFlowID + '_desc');
				...
				document.getElementById(thisObject.ImageFlowID+'_loading_txt').style.paddingTop = ((height * 0.5) -30) + 'px';
	...
	this.createStructure = function()
	{
		...
		var captionDiv = thisObject.Helper.createDocumentElement('h3', 'caption');
		var descDiv = thisObject.Helper.createDocumentElement('p', 'desc');
		...
		navigationDiv.appendChild(descDiv);
	...
	this.refresh = function()
	{
		...
		thisObject.captionDiv.style.width = (thisObject.imagesDivWidth / 1.25) + 'px';
		//thisObject.captionDiv.style.paddingTop = Math.round(thisObject.imagesDivWidth * 0.035) + 'px';

		thisObject.descDiv.style.width = (thisObject.imagesDivWidth / 2.2) + 'px';
		//thisObject.descDiv.style.paddingTop = Math.round(thisObject.imagesDivWidth * 0.01) + 'px';

		/* Change scrollbar div properties */
		thisObject.scrollbarDiv.style.width = thisObject.scrollbarWidth + 'px';
		thisObject.scrollbarDiv.style.marginTop = Math.round(thisObject.imagesDivWidth * 0.03) + 'px';
	...
	this.glideTo = function(imageID) {
	    ...
	    var desc = thisObject.imagesDiv.childNodes[imageID].getAttribute('desc');
	    if (desc === '' || thisObject.captions === false) {
	        desc = '&nbsp;';
	    }
	    thisObject.descDiv.innerHTML = desc;
	    ...
	    if (thisObject.MouseDrag.busy === false) {
			...
			if(!isNaN(this.newSliderX))
	       		thisObject.sliderDiv.style.marginLeft = (thisObject.newSliderX - thisObject.sliderWidth) + 'px';
	       //thisObject.sliderDiv.style.marginLeft = (thisObject.newSliderX - (thisObject.sliderWidth * 2)) + 'px';
	    }
